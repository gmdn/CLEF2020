find_labels_only_lemma_codiesp <- function(ith_doc) { #ith_doc <- 1
  
  ith_doc_id <- one_line_docs_test$doc_id[ith_doc]
  
  test_only_lemma <- str_detect(one_line_docs_test$only_lemma[ith_doc], 
                                one_line_codiesp_D$only_lemma)
  
  output_diag <- one_line_codiesp_D[which(test_only_lemma), ]
  ...
  test_only_lemma <- str_detect(one_line_docs_test$only_lemma[ith_doc], 
                                one_line_codiesp_P$only_lemma)
  
  output_proc <- one_line_codiesp_P[which(test_only_lemma), ]
